                    ...
                    <Col md={4} className="mb-3">
                      <div className="feature-card">
                        <div className="feature-title">
                          <i className="fa-solid fa-bullhorn text-warning"></i>
                          <span className="fw-semibold">Multi-Channel Campaigns</span>
                        </div>
                        <p className="small opacity-75">Send via SMS, Email, and WhatsApp with personalized messages</p>
                      </div>
                    </Col>
                    <Col md={4} className="mb-3">
                      <div className="feature-card">
                        <div className="feature-title">
                          <i className="fa-solid fa-target text-success"></i>
                          <span className="fw-semibold">Smart Targeting</span>
                        </div>
                        <p className="small opacity-75">Target specific customer segments based on behavior and preferences</p>
                      </div>
                    </Col>
                    <Col md={4} className="mb-3">
                      <div className="feature-card">
                        ...
                        <p className="small opacity-75">Track open rates, click rates, and review completion in real-time</p>
                      </div>
                    </Col>
                  </Row>
                </div>
          ...
          <div className="mb-4">
            ...
            <Card>
              <Card.Body className="quick-actions">
                <Button variant="primary" onClick={() => setShowCampaignWizard(true)} className="me-2">
                  ...
                  <Card key={campaign.id} className="campaign-card">
                    <Card.Body>
                      <div className="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div className="d-flex gap-2 campaign-actions">
                          <Button variant="outline-primary" size="sm" title="Edit Campaign">
                            <i className="fa-solid fa-edit"></i>
                            <span className="d-none d-md-inline ms-1">Edit</span>
                          </Button>
                          <Button variant="outline-secondary" size="sm" title="View Analytics">
                            <i className="fa-solid fa-chart-line"></i>
                            <span className="d-none d-md-inline ms-1">Stats</span>
                          </Button>
                          <Button variant="outline-danger" size="sm" title="Delete Campaign">
      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="bg-primary bg-opacity-10 p-4 rounded mb-4">
            <h5 className="text-primary mb-2">🎯 Create Your Campaign</h5>
            <p className="small text-muted mb-0">
              Follow our step-by-step wizard to create an effective review request campaign.
            </p>
          </div>
            ...
            <div>
              ...
              <Form>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control as="textarea" rows={3} placeholder="Brief description of this campaign..." />
                </Form.Group>
              </Form>
            </div>
          )}
